            ...
            <div className="bg-white flex-auto h-40 rounded-xl">
              <div className="flex flex-row h-full text-center items-center justify-center pr-20 pl-4 gap-4">
                <div className="flex flex-auto w-20">
                  <div className="flex flex-auto w-20 justify-center text-4xl font-bold">60%</div>
                </div>
                <div className="flex flex-initial w-28 text-gray-400">As vendas este mês aumentaram 60% a mais que o anterior</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white flex-auto h-28 rounded-xl">
              <div className="flex flex-col h-full py-6">
                ...
                <div className="flex flex-row flex-auto h-64 items-center justify-center text-2xl">
                  <div className="flex flex-auto justify-center w-1/3">Últimos Pedidos</div>
                  <div className="flex flex-auto justify-center w-1/3">Pedidos Enviados</div>
                  <div className="flex flex-auto justify-center w-1/3">Pedidos Entregues</div>
                </div>
              </div>
            </div>
            <div className="bg-white flex-auto h-72 rounded-xl">
              <div className="flex flex-col h-full px-8 py-4">
                <div className="flex flex-auto h-36">
                  <div className="flex flex-col h-full w-full">
                    ...
                    <div className="text-gray-400">Produtos vendidos no mês</div>
                  </div>
                </div>
                <div className="flex flex-auto h-64 items-center justify-center">grafico</div>
              </div>
            </div>
          </div>
        </div>
