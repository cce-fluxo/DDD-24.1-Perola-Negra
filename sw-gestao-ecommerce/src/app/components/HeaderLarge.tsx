...
interface HeaderProps {
  titulo?: string; // Título opcional, "LOGO" será o default
}

const HeaderLarge: React.FC<HeaderProps> = ({ titulo = "LOGO" }) => {
  ...
  return (
    <div className="bg-transparent w-full py-4 px-4 sm:px-8 lg:px-10 flex flex-col sm:flex-row items-start justify-between fixed top-0 z-50">
