...
const PopupAdd: React.FC<PopupAddProps> = ({ onClose, onConfirm }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white rounded-lg p-6 w-[950px] h-[450px]">
        ...
        <div className="text-center mt-8">
          <h2 className="text-4xl font-bold mb-4">Adicionar Produto</h2>
          <p className="text-2xl mt-24">Tem certeza que deseja adicionar esse produto?</p>
        </div>
