...
function CardMobile({
  ...
  return (
    <div className="w-full h-[20vh] flex justify-around my-2 p-4 rounded-xl bg-[#F2F2F2]">
      {/*Card-tabela para dispositivos mobile*/}

      <div className="bg-white w-[25vw] text-center rounded-lg">
        {/**Foto do produto */}
        {foto}
      </div>

      <div className="w-[40vw] flex flex-col justify-around rounded-xl">
        {/**Informacoes*/}

        <div className="font-bold text-center">{nome}</div>
        {/**Nome*/}
