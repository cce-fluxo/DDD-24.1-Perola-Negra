  ...
  return (
    <div className="h-full flex flex-col">
      <table className="w-full text-2xl text-center bg-[#F2F2F2] border-collapse rounded-t-2xl overflow-y-auto">
        ...
        <thead className="sticky top-0 bg-[#BDBDBD] h-[7vh] text-base text-white z-20">
          <tr>
            ...
            <th className="font-semibold border-none bg-[#BDBDBD] w-[23vw]">
              Cores
            </th>
            <th className="font-semibold border-none bg-[#BDBDBD]">
              Quantidade
            </th>
            <th className="font-semibold bg-[#BDBDBD] rounded-tr-2xl">
              Opções
            </th>{" "}
            {/* a1n */}
          </tr>
        ...
        <tbody>
          <tr>
            {" "}
            {/*Inicio Linha*/}
            <td className="py-5 bg-[#F2F2F2] border-l-0">
              {/**Foto+Nome Produto*/}
              <div className="h-[12vh] flex justify-center gap-2">
                <div className="rounded-lg lg:w-[7vw] xl:w-[6vw] bg-[#BDBDBD]">
                  {/**Foto do produto */}
                </div>
            ...
            <td className="bg-[#F2F2F2]">
              <MenuCheckBox nome="M" isTamanho></MenuCheckBox>
              {/**Menu para tamanhos*/}
            </td>
            <td className="py-5 bg-[#F2F2F2]">
              <MenuCheckBox nome="Amarelo" isCor></MenuCheckBox>
              {/**Menu para Cores*/}
            </td>
            ...
            <td className="py-5 px-4 border-r-0 bg-[#F2F2F2]">
              <div className="flex justify-center items-center w-[60%] mx-auto">
                ...
                <button
                  ...
                  className="bg-[url('/images/iconeExcluir.png')] bg-no-repeat bg-center bg-contain w-[3vw] h-[3vh]"
                ></button>
              </div>
            </td>{" "}
            {/* b1n */}
      ...
      {showPopup && popupAction === "adicionar" && (
        <PopupAdd onConfirm={handleConfirmPopup} onClose={handleClosePopup} />
      )}
      {showPopup && popupAction === "editar" && (
        <PopupEdit onConfirm={handleConfirmPopup} onClose={handleClosePopup} />
      )}
