    ...
    <table className="w-[100vw] text-2xl text-center bg-[#F2F2F2] border-collapse">
      ...
      <thead className="sticky top-0 bg-[#BDBDBD] h-[9vh] text-xl text-white">
        <tr>
          ...
          <th className="font-light border-none bg-[#BDBDBD]">Válido até</th> {/* a1n */}
        </tr>
      </thead>
      <tbody className="h-[25vh] overflow-y-auto">
        {!isAdicionar && (
          <>
            <tr> {/* Linhas do meio da tabela */}
              ...
              <td className="border-2 py-8 px-4 border-[#E0E0E0] border-t-0 bg-white">25% de<br />desconto</td>
        ...
        <tr> {/* Tem que ser a ultima linha da tabela */}
          ...
          <td className={`border-2 py-8 px-4 border-[#E0E0E0] border-b-0 bg-white ${isAdicionar ? 'border-t-0' : ''}`}>#123456789</td>
          <td className={`border-2 py-8 px-4 border-[#E0E0E0] border-b-0 bg-white ${isAdicionar ? 'border-t-0' : ''}`}>25% de <br></br>desconto</td>
          <td className={`border-2 py-8 px-4 border-[#E0E0E0] border-b-0 bg-white ${isAdicionar ? 'border-t-0' : ''}`}>563</td>
          <td className={`border-2 py-8 px-4 border-[#E0E0E0] border-b-0 border-r-0 bg-white ${isAdicionar ? 'border-t-0' : ''}`}>23/05/2023</td> {/* bnn */}
        </tr>
      </tbody>
    </table>
  );
