      ...
      <tbody className={`${isAdicionar ? "h-[15vh]" : ""}`}>
        {!isAdicionar && (
          <>
            <tr>
              {" "}
              {/* Linhas do meio da tabela */}
              <td className="py-5 px-14 border-2 border-[#E0E0E0] border-t-0 bg-white border-l-0">
                DDDIVOS
              </td>{" "}
              {/* b11 */}
              <td className="border-2 py-5 px-4 border-[#E0E0E0] border-t-0 bg-white">
                #123456789
              </td>
              <td className="border-2 py-5 px-4 border-[#E0E0E0] border-t-0 bg-white">
                25% de
            ...
            <tr>
              {" "}
              {/* Tem que ser a ultima linha da tabela */}
              <td
                className={`border-2 py-8 px-14 border-[#E0E0E0] border-b-0 border-l-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                DDIVOS
              </td>{" "}
              {/* bn1 */}
              <td
                className={`border-2 py-5 px-4 border-[#E0E0E0] border-b-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                #123456789
              ...
              <td
                className={`border-2 py-5 px-4 border-[#E0E0E0] border-b-0 border-r-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                23/05/2023
        ...
        {isAdicionar && (
          <>
            <tr>
              ...
              {/* Tem que ser a ultima linha da tabela */}
              <td
                className={`border-2 px-14 border-[#E0E0E0] border-b-0 border-l-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                Insira o nome do cupom
              </td>{" "}
              {/* bn1 */}
              <td
                className={`border-2 px-4 border-[#E0E0E0] border-b-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                Digite o código
              ...
              >
                Insira detalhes do cupom
              </td>
              <td
                className={`border-2 px-4 border-[#E0E0E0] border-b-0 border-r-0 bg-white ${
                  isAdicionar ? "border-t-0" : ""
                }`}
              >
                Defina a validade
