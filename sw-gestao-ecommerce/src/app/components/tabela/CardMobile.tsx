...
function CardMobile({nome = 'Nome',codigo = '#123445678',desconto,qtdUsada,validade}:any) {
  return (
    <div className='w-full h-[20vh] flex flex-col justify-between my-2 p-4 rounded-xl bg-[#BDBDBD] md:w-[38vw] md:h-[24vh]'>{/*Card-tabela para dispositivos mobile*/}
