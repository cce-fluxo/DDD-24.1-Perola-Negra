...
{/**isAdicionar verificar se esse card é um card para o cliente adicionar os cupons e nao apenas um card para ser mostrado ao cliente*/}
  return (
    ...
    <div className={`w-full h-[20vh] flex flex-col justify-between my-2 p-4 rounded-xl bg-[#BDBDBD] md:w-[38vw] md:h-[24vh] ${isAdicionar ? 'w-full h-full' : ''} `}>{/*Card-tabela para dispositivos mobile*/}
